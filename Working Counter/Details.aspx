...
<script runat="server">
    ...
    Sub Page_Load(s As Object, e As EventArgs)
        ...
        SQL = "SELECT * FROM Phrase WHERE ID = " & PID & ";" 'PID currently coming up as 0
    ...
    Sub btnPlay_Click(s As Object, e As EventArgs) Handles btnPlay.ServerClick
        parSound.InnerHtml = "<bgsound id='sndPlayer' src='" & Sound & "' runat='server'></bgsound>"
    End Sub
    
    Sub ibFave_Click(s As Object, e As EventArgs) Handles ibFave.Click
        parSound.InnerHtml = ""
        CN.Open()
